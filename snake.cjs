...
// +1. Исправить TODO
// 2. добавить gitignore нормальный (посмотреть какие файлы нужно исклдчить для проектов на node.js)
...
// 4. [опционально] - реализовать логику поля и ходы змеек для всех игроков
